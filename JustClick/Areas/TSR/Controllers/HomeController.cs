...
namespace JustClick.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        public HomeController(ILogger<HomeController> logger, IUnitOfWork unitOfWork,UserManager<ApplicationUser> userManager,SignInManager<ApplicationUser> signInManager)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            {
                Email = user.Email,
                FullName = user.FNAME_THAI + " " + user.LNAME_THAI
            });
        }
