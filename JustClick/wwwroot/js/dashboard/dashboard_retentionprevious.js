...
function retentionprevious() {


  //1
  $.ajax(
    {
      url: "/Admin/Dashboard/Getretentionprevious/",
      datatype: "json",
      success: (function (data1) {
        ...
        if (data1.data.length > 0) {
          ...
          row1 += '                             <div class="h1 icon icon-shape bg-green text-white rounded-circle shadow mb-0">' + retention;
